...
(function(){
    ...
    function init(){
        // app.storyView = new app.StoryView({collection: new app.StoryCollection()});
        $container = $('.container');
        $container.empty();
        ...
        if (location.hostname == "localhost") {
            ...
            firstSlideNum = app.storyData.story.first_slide;
            firstSlide = _.findWhere(app.storyData.photos, {id: firstSlideNum});
