...
RSpec.describe HotspotsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested hotspot as @hotspot" do
      hotspot = Hotspot.create! valid_attributes
      get :show, {:id => hotspot.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested hotspot as @hotspot" do
      hotspot = Hotspot.create! valid_attributes
      get :edit, {:id => hotspot.to_param}, valid_session
      expect(assigns(:hotspot)).to eq(hotspot)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Hotspot" do
        expect {
          post :create, {:hotspot => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved hotspot as @hotspot" do
        post :create, {:hotspot => invalid_attributes}, valid_session
        expect(assigns(:hotspot)).to be_a_new(Hotspot)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested hotspot" do
        hotspot = Hotspot.create! valid_attributes
        put :update, {:id => hotspot.to_param, :hotspot => new_attributes}, valid_session
        hotspot.reload
      ...
      it "assigns the requested hotspot as @hotspot" do
        hotspot = Hotspot.create! valid_attributes
        put :update, {:id => hotspot.to_param, :hotspot => valid_attributes}, valid_session
        expect(assigns(:hotspot)).to eq(hotspot)
      end
    ...
    context "with invalid params" do
      it "assigns the hotspot as @hotspot" do
        hotspot = Hotspot.create! valid_attributes
        put :update, {:id => hotspot.to_param, :hotspot => invalid_attributes}, valid_session
        expect(assigns(:hotspot)).to eq(hotspot)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested hotspot" do
      hotspot = Hotspot.create! valid_attributes
      expect {
        delete :destroy, {:id => hotspot.to_param}, valid_session
      }.to change(Hotspot, :count).by(-1)
    end
